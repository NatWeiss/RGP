...
App.getStoreAssets = function() {
	...
	var currency1 = Soomla.Models.VirtualCurrency.create({
		name: "Name",
		description: "",
		itemId: CURRENCY_ITEM_ID_1
	});

	// currency packs
	var smallCurrency1Pack = Soomla.Models.VirtualCurrencyPack.create({
		name: "Name Pack",
		description: "",
		itemId: "small_currency1_pack",
		currency_amount: 50,
		currency_itemId: CURRENCY_ITEM_ID_1,
		purchasableItem: Soomla.Models.PurchaseWithMarket.createWithMarketItem(
			"org.cocos2dx.hellojavascript.small_currency1_pack",
			0.99
		),
		facebookProductUrl: "http://cocos2dx.org/small_currency1_pack.html"
	});
	...
	var assets = {
		...
		currencyPacks: [smallCurrency1Pack],
		goods: {
			singleUse: [],
			lifetime: [],
			equippable: [],
