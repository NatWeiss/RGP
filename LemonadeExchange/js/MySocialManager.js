...
var MyShareResult = cc.Class.extend({});

if (typeof plugin.ShareResultListener !== 'undefined' ) {
	MyShareResult = plugin.ShareResultListener.extend({
...
*/        this._facebook = plugin.PluginManager.getInstance().loadPlugin("SocialFacebook");
		...
		cc.log("Facebook plugin: " + this._facebook);
